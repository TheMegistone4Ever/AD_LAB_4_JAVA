public class constants {
    ...
    public static final int ITERATIONS_PER_STEP = 10;
    ...
    public static final int ONLOOKER_BEES_COUNT = TOTAL_BEES_COUNT - EMPLOYED_BEES_COUNT;
    public static final int PALETTE_SIZE = VERTEX_COUNT;
}
